...
## Addresses
- Enter the addresses you want to optimize the route with, starting with the first address as the starting point and the last address as the ending point.
...
## Route Table
- See the detailed route and distances between stops.

## Preview Driving Directions
- Click the button to preview driving directions, which will take you to Google Maps.
""")
